...
# Para consultar la version que necesitamos
...
1. withColumnRenamed()
Este método:
Renombra una columna a la vez.
Existe desde versiones antiguas de Spark.
Debes encadenar múltiples llamadas si quieres renombrar varias columnas.
"""
...
Este método:
Permite renombrar múltiples columnas en una sola operación usando un diccionario.
Es más nuevo (Spark 3.4+).
